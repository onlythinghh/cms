...
// properties
// var buttons = require('./parts/ButtonsProps');
...
function createGeneralTabGroups(
    ...
    elementRegistry, elementTemplates, translate, config) {
    ...
    userTaskProps(detailsGroup, element, translate, config);
    ...
    candidateStarter(candidateStarterGroup, element, bpmnFactory, translate, config);
