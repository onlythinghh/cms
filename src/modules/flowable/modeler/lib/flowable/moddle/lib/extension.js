 ...
 */
FlowableModdleExtension.prototype.canCopyProperty = function(property, parent) {
    ...
    if (is(property, 'flowable:InputOutput') && !this.canHostInputOutput(parent)) {
        return false;
    }

    if (isAny(property, [ 'flowable:Connector', 'flowable:Field' ]) && !this.canHostConnector(parent)) {
        return false;
    }

};

FlowableModdleExtension.prototype.canHostInputOutput = function(parent) {
...
FlowableModdleExtension.prototype.canHostConnector = function(parent) {
